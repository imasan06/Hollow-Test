export const APP_CONFIG = {
  // Mock mode disabled by default for production
  // Set REACT_APP_MOCK_MODE=true to enable mock mode for testing
  BLE_MOCK_MODE: process.env.REACT_APP_MOCK_MODE === 'false',
